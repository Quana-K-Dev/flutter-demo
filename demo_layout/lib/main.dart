  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch, // GIÀN ĐIỀU RA stretch
          children: [
            // 1. Row & Column cơ bản
            ...
            Container(
              ...
              child: const Text('Container Demo: padding, margin, border, background'),
            ),
            ...
            SizedBox(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  const Text('Stack', style: TextStyle(color: Colors.white, fontSize: 20)),
                ],
              ),
            ),
...
class RowColumnDemo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const Text('1. Row & Column Basic', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            ...
            Expanded(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(child: Image.network('https://photo.znews.vn/w660/Uploaded/mdf_eioxrd/2021_07_06/2.jpg', fit: BoxFit.cover)),
                      Expanded(
                        flex: 2,
                        child: Image.asset('assets/images/pic2.jpg', fit: BoxFit.cover),
                      ),
                      Expanded(child: Image.asset('assets/images/pic3.jpg', fit: BoxFit.cover)),
                    ],
                  ),
